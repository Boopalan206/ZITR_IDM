FUNCTION zfm_get_filter_values.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  EXPORTING
*"     REFERENCE(ET_RESULT) TYPE  ZTT_IDOC_FILTER_VALUES
*"----------------------------------------------------------------------


  CONSTANTS:lv_function_id TYPE if_fdt_types=>id VALUE 'F10C74B575191EEFBFD2BE3A627B0473'.
