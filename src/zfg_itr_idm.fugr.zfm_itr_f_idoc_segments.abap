FUNCTION zfm_itr_f_idoc_segments.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"     VALUE(IM_IDOC_SEGNUM) TYPE  IDOCDSGNUM
*"  EXPORTING
*"     VALUE(EX_IDOC_DATA) TYPE  EDIDD
*"  TABLES
...
*"----------------------------------------------------------------------
  ...
  IF im_idoc_segment IS NOT INITIAL.
    ...
    IF gt_data[] IS NOT INITIAL.
      READ TABLE gt_data INTO DATA(ls_sdata) WITH KEY segnam = im_idoc_segment segnum = im_idoc_segnum.
    ENDIF.
        ...
        IF im_idoc_seg_num = 'X'.
          ...
          LOOP AT gt_data INTO ls_sdata1 WHERE segnam = im_idoc_segment.
            IF ls_sdata1-sdata IS NOT INITIAL.
              ...
              ls_e1edka1 = ls_sdata1-sdata.
              IF lv_data_qual IS NOT INITIAL.
                IF ls_e1edka1-parvw = lv_data_qual.
                  SPLIT im_idoc_sub_segment AT ',' INTO lv_split_qual lv_split_value.
                  ASSIGN COMPONENT lv_split_value OF STRUCTURE ls_e1edka1 TO <fs_sdata>.
                  MOVE lv_data_value TO <fs_sdata>.
                  ls_sdata1-sdata = ls_e1edka1.
                  EXIT.
                ENDIF.
              ENDIF.
              CLEAR: ls_sdata1.
            ELSE.
              SPLIT im_idoc_sub_segment AT ',' INTO lv_split_qual lv_split_value.
              ASSIGN COMPONENT lv_split_qual OF STRUCTURE ls_e1edka1 TO <fs_sdata>.
              MOVE lv_data_qual TO <fs_sdata>.
              ls_sdata1-sdata = ls_e1edka1.
...
*                  CLEAR: ls_sdata1.
    ...
    ENDCASE.
  ENDIF.
  IF ls_sdata1 IS NOT INITIAL.
    ex_idoc_data = ls_sdata1.
    CLEAR: ls_sdata1.
  ELSE.
    ex_idoc_data = ls_sdata.
    CLEAR: ls_sdata.
  ENDIF.
