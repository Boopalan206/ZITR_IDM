FUNCTION zfm_get_status_description.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  EXPORTING
*"     REFERENCE(ET_RESULT) TYPE  ZTT_IDOC_STATUS_DESC
*"----------------------------------------------------------------------

  CONSTANTS:lv_function_id TYPE if_fdt_types=>id VALUE 'F10C74B575191FD086DCFDAB51C9ECEC'.
